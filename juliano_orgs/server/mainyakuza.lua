...
if Configyakuza.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'yakuza', Configyakuza.MaxInService)
end
...
ESX.RegisterServerCallback('esx_yakuzajob:getOtherPlayerData', function(source, cb, target)
  ...
  if Configyakuza.EnableESXIdentity then
    ...
    if Configyakuza.EnableLicenses then
